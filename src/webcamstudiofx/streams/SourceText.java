...
import static webcamstudiofx.TruckliststudioUIController.lblText;
...
//            System.out.println("H set ... "+h);
    ...
    public void updateLineContent(String content) {
        Color bkgColor = Color.decode(bgColor);
        this.content = content;
        if (this.getIsQRCode()) {
            captureWidth = width;
            ...
            buffer.setColor(Color.decode(color));
    ...
    public static Color hex2Rgb(String colorStr) {
        return new Color(
                Integer.valueOf(colorStr.substring(0, 3), 16),
