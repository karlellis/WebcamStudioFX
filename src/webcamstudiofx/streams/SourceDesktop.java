...
import static webcamstudiofx.TruckliststudioUIController.lblDesktop;
...
public class SourceDesktop extends Stream {
    ...
    public SourceDesktop() {
        super();
//        name = "Desktop";
        name = lblDesktop.getText().replace("Desktops", "Desktop");
        rate = MasterMixer.getInstance().getRate();
        desktopW = Screen.getWidth(screenID[0]);
        System.out.println("Desktop0Width="+desktopW);
