    ...
    private void Listen() {
        ...
        try {
            ...
            while (!stopServer) {
                ...
                try {
                    // wait for request
//                    System.out.println("TrucklistStudio Remote accepting connections on port " + port);
                    listener.listening("http://" + InetAddress.getLocalHost().getHostName() + ".local:" + port);
                    ResourceMonitorLabelFX label = new ResourceMonitorLabelFX(System.currentTimeMillis() + 10000, "TSRemote listening port: " + WebRemote.getPort());
...
//                            System.out.println("Requesting /" + req);
                            ...
                            String path = ""; 
                            path = "/webcamstudiofx/remote/resources" + req + ".html";
...
//                + ":" + connection.getPort() + "] " + msg);
    ...
    private void errorReport(PrintStream pout, Socket connection,
        ...
        pout.print("HTTP/1.0 " + code + " " + title + "\r\n"
                ...
                + "</HEAD><BODY>\r\n"
                + "<H1>" + title + "</H1>\r\n" + msg + "<P>\r\n"
                + "<HR><ADDRESS>WebcamStudioFX 0.2 at "
