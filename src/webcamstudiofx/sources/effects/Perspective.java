...
public class Perspective extends Effect {
    ...
    public AnchorPane getControl() throws IOException {
        effectFX = this;
        AnchorPane PerspectiveControlFX = (AnchorPane) FXMLLoader.load(getClass().getResource("/webcamstudiofx/sources/effects/controls/PerspectiveControlFX.fxml"));
        return PerspectiveControlFX;
    }
