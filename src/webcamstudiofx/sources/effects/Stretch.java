...
//        System.out.println("height:"+height);
    ...
    public AnchorPane getControl() throws IOException {
        effectFX = this;
        AnchorPane StretchControlFX = (AnchorPane) FXMLLoader.load(getClass().getResource("/webcamstudiofx/sources/effects/controls/StretchControlFX.fxml"));
        return StretchControlFX;
    }
