...
public class Crop extends Effect {
    ...
    public AnchorPane getControl() throws IOException {
        effectFX = this;
        AnchorPane CropControlFX = (AnchorPane) FXMLLoader.load(getClass().getResource("/webcamstudiofx/sources/effects/controls/CropControlFX.fxml"));
        return CropControlFX;
    }
