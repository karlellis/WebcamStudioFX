...
public class RevealRightNFade extends Effect {
    ...
    public AnchorPane getControl() throws IOException {
        effectFX = this;
        AnchorPane RevealRightNFadeControlFX = (AnchorPane) FXMLLoader.load(getClass().getResource("/webcamstudiofx/sources/effects/controls/RevealRightNFadeControlFX.fxml"));
        return RevealRightNFadeControlFX;
    }
