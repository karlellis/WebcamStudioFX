...
public class RevealLeftNFade extends Effect {
    ...
    public AnchorPane getControl() throws IOException {
        effectFX = this;
        AnchorPane RevealLeftNFadeControlFX = (AnchorPane) FXMLLoader.load(getClass().getResource("/webcamstudiofx/sources/effects/controls/RevealLeftNFadeControlFX.fxml"));
        return RevealLeftNFadeControlFX;
    }
