 ...
 * @author karl
 */
public class RevealRightNFadeControlFXController implements Initializable {

    RevealRightNFade effect;

    @FXML
    private AnchorPane RevealRightNFadeControlFX;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        effect = (RevealRightNFade) effectFX;
